...
public class VehiculoController {
	...
	public ResponseEntity<Page<Vehiculo>> getTodosVehiculos(
	...
	public ResponseEntity<List<UbicacionVehiculosDTO>> getUbicacion(@RequestParam(required = false) Tipo tipo) {
		List<UbicacionVehiculosDTO> ubicaciones = vehiculoService.getUbicaciones(tipo);
	...
	public ResponseEntity<List<String>> getLocalidades() {
		List<String> localidades = vehiculoService.getLocalidadesDisponibles();
	...
	public ResponseEntity<Void> editarVehiculo(
	        @PathVariable int id,
	        @RequestPart(name = "vehiculo", required = false) @Valid EditarVehiculoDTO dto,
